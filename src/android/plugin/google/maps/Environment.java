...
public class Environment extends CordovaPlugin {
  ...
  public void initialize(final CordovaInterface cordova, final CordovaWebView webView) {
    if (Environment.isGooglePlayAvailable(cordova)) {
  ...
  /**
   * Check is GMS available
   */
  public static boolean isGooglePlayAvailable(final CordovaInterface cordova) {
    boolean googlePlayStoreInstalled;
    int val = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(cordova.getActivity());
